...
const Dashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 fixed inset-0 pt-14">
      <WelcomeModal />
      <div className="h-full overflow-y-auto">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          ...
          >
            ...
            <motion.div variants={itemVariants} className="mb-6 max-w-md mx-auto">
